...
def el_callbacks(name, listener_only: bool = ...) -> Generator[Any, None, None]: ...
def vel_callbacks(v, name, listener_only: bool = ...) -> Generator[Any, None, None]: ...
...
class MultizipImporter(importlib.abc.MetaPathFinder):
    loaders: Any
    def __init__(self) -> None: ...
    def find_spec(self, fullname, path, target: Any | None = ...): ...
