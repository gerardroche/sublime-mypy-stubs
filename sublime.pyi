...
from sublime_types import ValueType
...
def expand_variables(val: Any, variables: DictValueType) -> str: ...
...
class Window:
    ...
    def show_input_panel(self, caption: str, initial_text: str, on_done: Optional[Callable[[str], None]], on_change: Optional[Callable[[str], None]], on_cancel: Optional[Callable[[], None]]) -> View: ...
    def show_quick_panel(self, items: List[Any], on_select: Callable[[int], None], flags: int = ..., selected_index: int = ..., on_highlight: Optional[Callable[[int], None]] = ...) -> None: ...
