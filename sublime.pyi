...
PointType = int
ValueType = Union[bool, int, float, str, list, dict]
...
class Window:
    ...
    def run_command(self, cmd: str, args: Dict[str, ValueType] = ...) -> None: ...
    def new_file(self, flags: Optional[int], syntax: Optional[str]) -> View: ...
    def open_file(self, fname: str, flags: Optional[int], group: Optional[int]) -> View: ...
    ...
    def show_input_panel(self, caption: str, initial_text: str, on_done: Optional[Callable], on_change: Optional[Callable], on_cancel: Optional[Callable]) -> View: ...
    def show_quick_panel(self, items: List[Any], on_select: Optional[Callable], flags: Optional[int], selected_index: Optional[int], on_highlight: Optional[Callable]) -> None: ...
...
class View:
    ...
    def size(self) -> int: ...
    def begin_edit(self, edit_token: int, cmd: str, args: Dict[str, ValueType] = ...) -> Edit: ...
    ...
    def add_phantom(self, key: str, region: Region, content: str, layout: int, on_navigate: Optional[Callable]) -> None: ...
    ...
    def show_popup_menu(self, items: List[str], on_select: Optional[Callable], flags: Optional[int]) -> None: ...
    def show_popup(self, content: str, flags: Optional[int], location: Optional[int], max_width: Optional[int], max_height: Optional[int], on_navigate: Optional[Callable], on_hide: Optional[Callable]) -> None: ...
...
class Settings:
    ...
    def __init__(self, id: int) -> None: ...
    def get(self, key: str, default: ValueType = ...) -> Optional[ValueType]: ...
